...
namespace Object_Detection {
	...
	extern boost::atomic_int iteral_count;
	...
	extern int WINDOW_HEIGHT; //pixel
	extern int ROI_WIDTH;
	extern int ROI_HEIGHT;  //pixel
	extern double FOCAL_DISTANCE; //mm
	extern double CCD_WIDTH; //mm

	extern int THREAD_NUM;
	extern int POPULATION_SIZE;
	extern int THRESHOLD_FINAL;
	extern int GEN_MAX;
	extern double DE_wight_factor;
	extern double DE_crossover_factor;
	extern double DT_match_min_factor;
	extern double DT_match_max_factor;
	extern int print_option;
	extern bool is_create_sample;
}